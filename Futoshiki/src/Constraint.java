...
/**
 * Enum used to represent the inequalities 
 * in a Futoshiki puzzle.  
 * 
 * @author Prof. Yilek for use on CISC 230 Lab 6
 *
 */
public enum Constraint {
    /** Constant to represent a less-than inequality.  The vertical display is an upside-down V. */
    LESS("<","^"),
     ...
     * 
     * @param horizontalDisplay How the constraint should be displayed if it is used horizontally
     * @param verticalDisplay How the constant should be displayed if it is used vertically
     */
     ...
     * @return true if the inequality is satisfied or if the constant is NONE, false otherwise.
     */
    ...
    /**
     * Method to return a string representation of the constraint.  
     * The getVerticalDisplay and getHorizontalDisplay should be used 
     * instead, but this method defaults to the horizontal display 
     * since the vertical may not be ASCII characters.
     */
